// Intercepting Routes - modal, but if you refresh you go to page. (images modal on click
//                       but if you refresh it goes to that image page, login modal,
//                       but if you refresh go to login page)
// --------------------------------------------------------------------------------------
//
// (.)       - means our toure is defined somewhere in its folder
// (.)1      - search for specific route (1)
// (.)apples - search for specfic route (apples)
//
//
...
//           <div className="w-50" key={product.id}>
...
//     },
//   ];
//   const findProduct = products.find((f) => f.id === Number(product));
